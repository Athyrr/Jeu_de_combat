...
namespace Jeu_de_combat
{
    public class GameDisplay
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Damager
            const string damL = "   O  _\n  /|-/ \n   |   \n  / \\  ";
            const string damR = "_  O   \n \\-|\\ \n   |   \n  / \\  ";
            const string bullet = "__";
            const ConsoleColor damC = ConsoleColor.DarkYellow;
            const ConsoleColor damCspecial = ConsoleColor.Red;
            ConsoleColor bulletC = gridTextC;

            // Healer
            const string heaL = "   A @ \n  /|-| \n   | | \n  / \\  ";
            const string heaR = " @ A   \n |-|\\  \n | |   \n  / \\  ";
            const ConsoleColor heaC = ConsoleColor.DarkMagenta;
            const string magicBall = "o";

            // Tank
            const string tanL = "   O | \n 0-|-| \n   |   \n  / \\  ";
            const string tanR = " | O   \n |-|-0 \n   |   \n  / \\  ";
            const string tanLbody = "   O | \n 0-|-| \n   |   ";
            const string tanRbody = " | O   \n |-|-0 \n   |   ";
            const string tanLattack = "   O  /\n 0-|\\/ \n   |   ";
            const string tanRattack = "\\  O   \n \\/|-0 \n   |   ";
            const ConsoleColor tanCneutral = ConsoleColor.DarkBlue;
            const ConsoleColor tanCspecial = ConsoleColor.Red;
            ConsoleColor tanC = tanCneutral;
            string[] leg = ["\n  / \\  ", "\n   |\\  ", "\n  /|   ", "\n  / \\  "];
            ...
            //TankSpecialAnim(true);
            //HealerSpecialAnim(false);


            void Game()
            {
                OpenAnim();
                ButSelect(["Quit", "Play", "Credits"], [defaultText]);
            }
            ...
            void Fight()
            {
                ...
                for (int i = 10; i >= 0; i--)
                {
                    StringToGrid(damL, charLeft - i, 2, heaC, 1, 0);
                    StringToGrid(damR, charRight + i, 2, tanC, -1, 0);
